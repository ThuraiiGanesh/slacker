...
if __name__ == "__main__":
    # Host on all interfaces, reading port dynamically from environment (default to 8000)
    port = int(os.environ.get("PORT", 8000))
    logger.info(f"Starting SyncUp AI FastAPI backend & Web server on port {port}")
